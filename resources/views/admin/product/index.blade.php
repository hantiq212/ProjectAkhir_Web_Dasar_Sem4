        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <!-- Tombol Add Product -->
                    <a href="{{ route('admin.product.create') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                        Add Product
                    </a>
                </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 border-b border-gray-200">
                                @if ($product->image)
                                <img src="{{ asset('storage/' . $product->image) }}" alt="Product Image" class="w-16 h-16">
                                @else
                                No Image
                                @endif
                            </td>
                            ...
                            <td class="px-6 py-4 border-b border-gray-200">
                                ...
                                <form action="{{ route('admin.product.destroy', $product) }}" method="POST" class="inline-block">
                                    @csrf
                                    @method('DELETE')
